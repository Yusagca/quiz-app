    ...
    return (
        <div className='flex flex-col text-center text-white items-center justify-center'>
                ...
                <div className='w-[230px] flex flex-col'>
                    ...
                    <button onClick={() => dispatch(setNicknameStore({'nickname': nickname}))} className='bg-white hover:bg-gray-200 text-black font-bold py-2 px-4 rounded-lg'>Quize başla</button>
                </div>
        </div>
    )
}
